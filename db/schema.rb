...
ActiveRecord::Schema.define(version: 2020_04_09_150561) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "blogit_comments", id: :serial, force: :cascade do |t|
  ...
  create_table "blogit_posts", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.text "description"
    t.index ["blogger_type", "blogger_id"], name: "index_blogit_posts_on_blogger_type_and_blogger_id", unique: true
  end
